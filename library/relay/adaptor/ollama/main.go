...
import (
	...
	"demogogo/library/relay/common/helper"
	"demogogo/library/relay/common/image"
	"demogogo/library/relay/common/logger"
	"demogogo/library/relay/common/random"
	"demogogo/library/relay/common/render"
	"demogogo/library/relay/constant"
...
func StreamHandler(c context.Context, resp *http.Response) (*model.ErrorWithStatusCode, *model.Usage) {
...
func EmbeddingHandler(c context.Context, resp *http.Response) (*model.ErrorWithStatusCode, *model.Usage) {
...
func Handler(c context.Context, resp *http.Response) (*model.ErrorWithStatusCode, *model.Usage) {
	...
	logger.Debugf(c, "ollama response: %s", string(responseBody))
	err = resp.Body.Close()
	if err != nil {
		return openai.ErrorWrapper(err, "close_response_body_failed", http.StatusInternalServerError), nil
	}
